...
{
	GEngine->AddOnScreenDebugMessage(-1, 15.0f, FColor::Red, TEXT("Tag Update CPP"));
}
...
void AShootingCodeGameCharacter::EventGetItem_Implementation(EItemType ItemType)
{
	...
	{
		GEngine->AddOnScreenDebugMessage(-1, 15.0f, FColor::Red, TEXT("Enum Mag"));
	...
	{
		GEngine->AddOnScreenDebugMessage(-1, 15.0f, FColor::Red, TEXT("Enum Heal"));
